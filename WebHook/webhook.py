...
def webhook():
    if request.method == 'GET':
                ...
                <div class="container">
                    ...
                    <form action="/webhook" method="post" id="messageForm">
                        <div class="form-group">
                            ...
                            <input type="text" id="number" name="number" value="** * ********" required>
                        </div>
                        <div class="form-group">
        ...
        try:
            ...
            # Extrai o número e a mensagem dos dados recebidos
            number = webhook_data.get('number')
            message = webhook_data.get('message')
            
            if not number or not message:
                return jsonify({"status": "erro", "mensagem": "Número e mensagem são obrigatórios"}), 400
